...
#Region " Web Form Designer Generated Code "
    ...
    End Sub
    Protected WithEvents blgos As System.Web.UI.WebControls.Repeater
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      pa.addInt("@pnum", pnum)
      sql = "select_ajax_blog_page"

      blogs.DataSource = connHelper.retrieve(sql, CommandType.StoredProcedure, pa.parameters)

...
Imports System.Net
Public Class GeoIP
    Public Shared myms As MemoryStream
    ...
    Private Shared CountryCode As String() = {"unknown", "AP", "EU", "AD", "AE", "AF", "AG", "AI", "AL", "AM", "AN", "AO", "AQ", "AR", "AS", "AT", "AU", "AW", "AZ", "BA", "BB", "BD", "BE", "BF", "BG", "BH", "BI", "BJ", "BM", "BN", "BO", "BR", "BS", "BT", "BV", "BW", "BY", "BZ", "CA", "CC", "CD", "CF", "CG", "CH", "CI", "CK", "CL", "CM", "CN", "CO", "CR", "CU", "CV", "CX", "CY", "CZ", "DE", "DJ", "DK", "DM", "DO", "DZ", "EC", "EE", "EG", "EH", "ER", "ES", "ET", "FI", "FJ", "FK", "FM", "FO", "FR", "FX", "GA", "GB", "GD", "GE", "GF", "GH", "GI", "GL", "GM", "GN", "GP", "GQ", "GR", "GS", "GT", "GU", "GW", "GY", "HK", "HM", "HN", "HR", "HT", "HU", "ID", "IE", "IL", "IN", "IO", "IQ", "IR", "IS", "IT", "JM", "JO", "JP", "KE", "KG", "KH", "KI", "KM", "KN", "KP", "KR", "KW", "KY", "KZ", "LA", "LB", "LC", "LI", "LK", "LR", "LS", "LT", "LU", "LV", "LY", "MA", "MC", "MD", "MG", "MH", "MK", "ML", "MM", "MN", "MO", "MP", "MQ", "MR", "MS", "MT", "MU", "MV", "MW", "MX", "MY", "MZ", "NA", "NC", "NE", "NF", "NG", "NI", "NL", "NO", "NP", "NR", "NU", "NZ", "OM", "PA", "PE", "PF", "PG", "PH", "PK", "PL", "PM", "PN", "PR", "PS", "PT", "PW", "PY", "QA", "RE", "RO", "RU", "RW", "SA", "SB", "SC", "SD", "SE", "SG", "SH", "SI", "SJ", "SK", "SL", "SM", "SN", "SO", "SR", "ST", "SV", "SY", "SZ", "TC", "TD", "TF", "TG", "TH", "TJ", "TK", "TM", "TN", "TO", "TL", "TR", "TT", "TV", "TW", "TZ", "UA", "UG", "UM", "US", "UY", "UZ", "VA", "VC", "VE", "VG", "VI", "VN", "VU", "WF", "WS", "YE", "YT", "RS", "ZA", "ZM", "ME", "ZW", "A1", "A2", "O1", "AX", "GG", "IM", "JE"}

    Public Shared Sub init(ByVal ms As MemoryStream)
        myms = ms
    End Sub

    Public Shared Sub init(ByVal FileLocation As String)
        '------------------------------------------------------------------------------------------------
        ...
        While _FileStream.Read(_Byte, 0, _Byte.Length) <> 0
            myms.Write(_Byte, 0, _Byte.Length)
        End While
        _FileStream.Close()
    End Sub

    Private Shared Function ConvertIPAddressToNumber(ByVal _IPAddress As IPAddress) As Long
        '------------------------------------------------------------------------------------------------
    ...
    Private Shared Function ConvertIPNumberToAddress(ByVal _IPNumber As Long) As String
        '------------------------------------------------------------------------------------------------
    ...
    Public Shared Function FileToMemory(ByVal FileLocation As String) As MemoryStream
        ...
        Return _MemStream
    End Function
    Public Overloads Shared Function LookupCountryCode(ByVal _IPAddress As IPAddress) As String
        '------------------------------------------------------------------------------------------------
    ...
    End Function
    Public Overloads Shared Function LookupCountryCode(ByVal _IPAddress As String) As String
        '------------------------------------------------------------------------------------------------
        ' Look up the country code, e.g. US, for the passed in IP Address
        '------------------------------------------------------------------------------------------------
    ...
    End Function
    Public Overloads Shared Function LookupCountryName(ByVal addr As IPAddress) As String
        '------------------------------------------------------------------------------------------------
    ...
    End Function
    Public Overloads Shared Function LookupCountryName(ByVal _IPAddress As String) As String
        '------------------------------------------------------------------------------------------------
        ' Look up the country name, e.g. United States, for the IP Address
        '------------------------------------------------------------------------------------------------
        Dim _Address As IPAddress
    ...
    End Function
    Private Shared Function vbShiftLeft(ByVal Value As Long, ByVal Count As Integer) As Long
        '------------------------------------------------------------------------------------------------
    ...
    Private Function vbShiftRight(ByVal Value As Long, ByVal Count As Integer) As Long
        ...
        Next
    End Function
    Private Shared Function SeekCountry(ByVal StartOffset As Long, _
        ...
        End If
        Try
            myms.Seek(6 * StartOffset, 0)
            myms.Read(_Buffer, 0, 6)

...
<div align="left">
<a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml" class="title"><%# Container.DataItem("title") %></a></div>
			
			<div style="text-align:right"><%=nick%> winks at <%# Container.DataItem("add_date") %> <a class="s" href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"> Comments(<%#Container.DataItem("comment")%>) </a></div>
			<br>
			</ItemTemplate>
</asp:Repeater>

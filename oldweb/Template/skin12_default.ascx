...
<DIV class="blog">
	  <asp:Repeater id="dlArticles" runat="server">
		<ItemTemplate>				
				<table width=100%><tr><td><a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"><font size="3" color=black><b><%# Container.DataItem("title") %></b></font></a>
				<td align="right"><img border="0" src="/images/skins/skin12/mao2.jpg" width="77" height="50"></table>
			   <div align="justify"><%#Container.DataItem("content")%> </div><br><div class="PostFooter">
			   - - - - - - - - - - - - - - - - - - - - - - - <%=nick%> <img border="0" src="/images/skins/skin12/miao.jpg" width="24" height="19"><%# Container.DataItem("add_date") %> 
			<a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml">评论:<%#Container.DataItem("comment")%></a></div>
		</ItemTemplate>
		<AlternatingItemTemplate>				
				<table width=100%><tr><td><a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"><font size="3" color=black><b><%# Container.DataItem("title") %></b></font></a>
				<td align="right"><img border="0" src="/images/skins/skin12/mao1.jpg" width="84" height="56"></table>
			   <div align="justify"><%#Container.DataItem("content")%> </div><br><div class="PostFooter">
			   - - - - - - - - - - - - - - - - - - - - - - - <%=nick%> <img border="0" src="/images/skins/skin12/miao.jpg" width="24" height="19"><%# Container.DataItem("add_date") %> 
			<a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml">评论:<%#Container.DataItem("comment")%></a></div><br><br>
		</AlternatingItemTemplate>

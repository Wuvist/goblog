...
<div class="blogs"><%=content%><br></div><br>
...
<INPUT type="hidden" name="TitleText" value="回复：<%=title%>">
	　 <font size="2">名字：</font><INPUT type="text" name="AuthorText"  size=35 class="input" maxlength=50 value="<%=viewer%>"><br>
	　 <font size="2">主页：</font><INPUT type="text" name="HomepageText"  size=35 class="input" value="<%=hp%>" maxlength=255><br>
	　 <font size="2">内容：</font><br/><TEXTAREA name="ContentText" rows="6" cols="45"></TEXTAREA></p>

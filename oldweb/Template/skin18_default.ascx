...
<asp:Repeater id="dlArticles" runat="server">
	<ItemTemplate>
      ...
      border=0>
        ...
        <TR>
          ...
          height=36><IMG height=3 src="/images/skins/skin18/pic_lit_001.gif" width=8 
            align=absMiddle> <B><a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml" class="title"><%# Container.DataItem("title") %></a></B></TD>
      ...
      border=0>
        <TBODY>
        <TR>
          <TD><IMG height=7 src="/images/skins/skin18/line1.gif" width=516></TD></TR>
        <TR>
          <TD align=middle><SPAN class=multipage><uc1:userpaging runat="server" ID="paging"/> </SPAN></TD></TR>
        <TR>
          <TD><IMG height=7 src="/images/skins/skin18/line1.gif" 

...
<asp:Repeater id="dlArticles" runat="server">
	...
	<p><font color="orange">>></font>　<font color="#999999"><%=nick%> @ <%# Container.DataItem("add_date") %> <a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"><%=ph.g("评论")%>： <font color="orange"><%#Container.DataItem("comment")%></a></font>. </font></p>
<hr color="660000">
	</ItemTemplate>
</asp:Repeater>
</div>

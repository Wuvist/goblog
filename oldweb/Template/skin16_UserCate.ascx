    ...
    <TD>
      <TABLE cellSpacing=0 cellPadding=0 align=right border=0>
        ...
        <TR>
          ...
          background=/images/skins/skin16/qback5.gif><div align="center" class="style5"><strong><%=path%></strong></div></TD>
...
border=0>
              <TBODY>
              <TR>
                <TD class=text><br><div align=right> <%=nick%> @ <%# Container.DataItem("add_date") %> <a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml">评论:<%#Container.DataItem("comment")%></a> </div>
                </TD></TR></TBODY></TABLE></ItemTemplate>
	</asp:Repeater></TD></TR>
        <TR>
          <TD bgColor=#dbdbdb height=13><BR></TD></TR>
        <TR>
...
<TABLE cellSpacing=0 cellPadding=0 width=750 align=center border=0>
  ...
  <TR>
    ...
    <TD align=middle width=748 background=/images/skins/skin16/qback2.gif></TD>

...
<LINK media=all href="/Template/skin24.css" type=text/css rel=Stylesheet>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
</head>
<body>
<DIV class=pagelayout>
<DIV id=header><SPAN><A id=Header1_HeaderTitle href="#"><%=path%></A><BR><%=uinfo%></SPAN></DIV>
<DIV id=menu><Acme:userpic runat="server" ID="userpic1" deco="<div align='center'><br><img src='" enddeco="'></div>"/>
<H1><%=ph.g("导航")%></H1>
<UL class=list>

...
<td width="80%">
	...
	<DIV class="blog">
		...
		<ItemTemplate>				
				...
				<a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"><font size="3" color=black><b><%# Container.DataItem("title") %></b></font></a>
				<div align="justify"><%#Container.DataItem("content")%> </div><br><div class="PostFooter">
			   <%=nick%> <img border="0" src="/images/skins/skin13/f1.gif" width="24" height="18"><%# Container.DataItem("add_date") %> 

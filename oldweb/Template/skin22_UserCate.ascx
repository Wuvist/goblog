...
<asp:Repeater id="dlArticles" runat="server">
		<ItemTemplate>
<table border="0" cellpadding="0" cellspacing="0"><tr><td align="center"><table border="0" cellpadding="0" cellspacing="0"><tr><td class="up"><div class="sysBr500 title"><a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"><%# Container.DataItem("title") %></a></div></td></tr></table></td></tr><tr><td class="aBody"><table align="center" border="0" cellpadding="0" cellspacing="0" class="dashed"><tr><td></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="aSize"><tr><td align="right"><%=nick%> 发表于 <%# Container.DataItem("add_date") %>  

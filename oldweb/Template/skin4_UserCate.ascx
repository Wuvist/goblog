...
<div align="center">
  <center>
  <table width="564" height="584" style="font-family: Verdana; color: #FF66FF; font-size: 9pt" cellspacing="4" cellpadding="4" bgcolor="#FFFFFF">
    <tr>
    ...
    <tr>
      ...
      <asp:Repeater id="dlArticles" runat="server">
						<ItemTemplate>
						<p><a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"><font color="cc66ff" size="3"><b><%# Container.DataItem("title") %></b></font></a><br />
						<font color="#999999">>></a><%=nick%> 发表于： <%# Container.DataItem("add_date") %> <a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml">评论： <font color="orange"><%#Container.DataItem("comment")%></a></font>. </font></p>
<hr >
...
<asp:Repeater id="archive" runat="server">
	...
	<br></p>
      <p><b><span class="title"><%=ph.g("累计浏览")%>: <%=count%></span></b>

...
<LINK media=all href="/Template/skin31.css" type=text/css rel=Stylesheet>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
</head>
<body>
<DIV class=pagelayout>
<DIV id=header><SPAN id="headertitle"><A id=Header1_HeaderTitle href="#"><%=path%></A></SPAN><br clear="all"><span id="user_info"><a ><%=uinfo%></a></SPAN></DIV>
<DIV id=menu><UL class=list><Acme:userpic runat="server" ID="userpic1" deco="<div align='center'><img src='" enddeco="'></div>"/></UL>
<H1><%=ph.g("导航")%></H1>
<UL class=list>
...
<H1></H1>
<ul class="list"><%=ph.g("累计浏览")%>: <%=count%></ul>
...
<DIV class=postText><%#Container.DataItem("content")%></DIV>
...
</DIV><DIV class=spacer>&nbsp;</DIV></ItemTemplate>

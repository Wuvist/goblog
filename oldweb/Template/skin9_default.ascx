...
<asp:Repeater id="dlArticles" runat="server">
	<ItemTemplate>
			<a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"><div class="DateHeader"><%# Container.DataItem("title") %></div></a><br>
			<div style="word-break:break-all"><%#Container.DataItem("content")%></div><br/>

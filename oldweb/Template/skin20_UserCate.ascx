...
<table width="100%" cellpadding="0">
	...
	<ItemTemplate>
		...
		<tr><td valign="center">
			...
			<img src="/images/skins/skin20/starr.jpg" align="middle"><b><a class="s" href="/<%# uid & "/" & Container.DataItem("index")%>.shtml" class="title"><%# Container.DataItem("title") %></a><b></td><td valign="center">
			
			<div style="text-align:right"><%=nick%> 发表于 <%# Container.DataItem("add_date") %> <a class="s" href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"> 评论 [<%#Container.DataItem("comment")%>] </a></div>

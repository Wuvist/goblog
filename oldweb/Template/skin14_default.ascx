...
<table width=950 border="0" align="center">
  ...
  <tr> 
	...
	<asp:Repeater id="dlArticles" runat="server">
		<ItemTemplate>				
			<table width=100%><tr><td><a href="/<%# uid & "/" & Container.DataItem("index")%>.shtml"><font size="3" color=#CCCCCC><b><%# Container.DataItem("title") %></b></font></a>
			<td align="right"></table>
			<div align="justify"><%#Container.DataItem("content")%> </div><br><div class="PostFooter">
<hr><img border="0" src="/images/skins/skin14/grey-comment.gif" width="15" height="15"><%=nick%><%# Container.DataItem("add_date") %> 

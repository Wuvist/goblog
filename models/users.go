...
type User struct {
	...
	PWD       []byte      `boil:"pwd" json:"pwd" toml:"pwd" yaml:"pwd"`
	Bloggerid null.Int    `boil:"bloggerid" json:"bloggerid,omitempty" toml:"bloggerid" yaml:"bloggerid,omitempty"`
	Pid       null.Int    `boil:"pid" json:"pid,omitempty" toml:"pid" yaml:"pid,omitempty"`
	Profile   int         `boil:"profile" json:"profile" toml:"profile" yaml:"profile"`
...
var (
	userColumns               = []string{"id", "email", "user_name", "pwd", "bloggerid", "pid", "profile", "status"}
	userColumnsWithoutDefault = []string{"id", "email", "user_name", "pwd", "bloggerid", "pid"}
	userColumnsWithDefault    = []string{"profile", "status"}
